...
#define LTC2943_I2C_ADDRESS 0x64 << 1
...
@{ */
#define LTC2943_CHARGE_lsb              0.34E-3
#define LTC2943_VOLTAGE_lsb             1.44E-3
#define LTC2943_CURRENT_lsb             29.3E-6
#define LTC2943_TEMPERATURE_lsb         0.25
#define LTC2943_FULLSCALE_VOLTAGE       23.6
#define LTC2943_FULLSCALE_CURRENT       60E-3
...
//! Calculate the LTC2943 charge in RAW
//! @return Returns the RAW of charge in the ACR register.
uint16_t LTC2943_mAh_to_code(float mAh_charge,  //!< The charge value
                             float resistor,    //!< The sense resistor value
                             uint16_t prescalar //!< The prescalar value
);
...
//! Calculate the LTC2943 voltage in RAW
//! @return Returns the RAW of voltage
...
//! Calculate the LTC2943 current in RAW
//! @return Returns the RAW of current
uint16_t LTC2943_current_to_code(float current,
                                 float resistor
);
...
//! Calculate the LTC2943 temperature in RAW
//! @return Returns the RAW of temperature
