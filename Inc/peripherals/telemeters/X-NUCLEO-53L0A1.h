/**
 * @file X-NUCLEO-53L0A1.h
 *
 *  Created on: Nov 3, 2015
 *      Author: ST Imaging
 */

#ifndef _X_NUCLEO_53L0A1_H_
#define _X_NUCLEO_53L0A1_H_

#include  "stm32h7xx_hal.h"


/**
 * @defgroup VL53L0A1_config  VL53L0A1 static configuration
...
/** @ingroup VL53L0A1_config
 * @{*/


#ifndef VL53L0A1_HAVE_UART
/**
 * Define this macro at project level if UART is available
 */
#	define VL53L0A1_HAVE_UART 0
#endif
...
#ifndef VL53L0A1_UART_DMA_RX
/** configure use of dma for uart rx
 *
 * Default to not use DMA RX when not defined explicitly
 *
 * require @a VL53L0A1_HAVE_UART
 */
#   define VL53L0A1_UART_DMA_RX   0
#endif //VL53L0A1_UART_DMA_RX

#ifndef VL53L0A1_UART_DMA_TX
 ...
 * require @a VL53L0A1_HAVE_UART
 */
#   define VL53L0A1_UART_DMA_TX   1
#endif //VL53L0A1_UART_DMA_RX


#ifndef  VL53L0A1_UART_DMA_RX_IRQ_PRI
 ...
 */
#   define  VL53L0A1_UART_DMA_RX_IRQ_PRI   0
#endif

#ifndef  VL53L0A1_UART_DMA_TX_IRQ_PRI
...
#   define  VL53L0A1_UART_DMA_TX_IRQ_PRI   0
#endif
...
extern void XNUCLEO53L0A1_USART2_UART_Init(void);

#else
#	define XNUCLEO53L0A1_USART2_UART_Init(...) (void)0
#endif
 ...
 */
#define VL53L0A1_INTR_PIN_PUPD GPIO_PULLUP



/**
 * @ingroup VL53L0A1_GPIO1_MAP
 * @{
 */

#ifndef VL53L0A1_GPIO1_SHARED
/**
 ...
 * see @sa VL53L0A1_GPIO1_C_OPTION
 */
#   define VL53L0A1_GPIO1_SHARED  0
#endif


#ifndef VL53L0A1_GPIO1_C_OPTION
/**
 * @def VL53L0A1_GPIO1_C_OPTION
 ...
 */
#   define VL53L0A1_GPIO1_C_OPTION 0
#endif

#ifndef VL53L0A1_GPIO1_L_OPTION
/**
 * @def VL53L0A1_GPIO1_L_OPTION
 ...
 */
#   define VL53L0A1_GPIO1_L_OPTION 0
#endif

#ifndef VL53L0A1_GPIO1_R_OPTION
/**
 * @def VL53L0A1_GPIO1_R_OPTION
 ...
 */
#   define VL53L0A1_GPIO1_R_OPTION 0
#endif


#if VL53L0A1_GPIO1_C_OPTION == 0
#   define VL53L0A1_GPIO1_C_GPIO_PORT   GPIOA
#   define VL53L0A1_GPIO1_C_CLK_ENABLE  __GPIOA_CLK_ENABLE
#   define VL53L0A1_GPIO1_C_GPIO_PIN    GPIO_PIN_4
#   if defined(STM32F401xE) || defined(STM32L476xx)
#       define VL53L0A1_GPIO1_C_INTx       EXTI4_IRQn
#       define VL53L0A1_EXTI4_USE_PIN      VL53L0A1_GPIO1_C_GPIO_PIN
#   endif
#   if defined(STM32L053xx)
#       define VL53L0A1_GPIO1_C_INTx        EXTI4_15_IRQn
#       define VL53L0A1_EXTI4_15_USE_PIN    VL53L0A1_GPIO1_C_GPIO_PIN
#   endif // STM32L053xx
#else
#   define VL53L0A1_GPIO1_C_CLK_ENABLE  __GPIOC_CLK_ENABLE
#   define VL53L0A1_GPIO1_C_GPIO_PORT   GPIOC
#   define VL53L0A1_GPIO1_C_GPIO_PIN    GPIO_PIN_1
#   if defined(STM32F401xE) || defined(STM32L476xx)
#       define VL53L0A1_GPIO1_C_INTx        EXTI1_IRQn
#       define VL53L0A1_EXTI1_USE_PIN       VL53L0A1_GPIO1_C_GPIO_PIN
#   endif // STM32F401xE
#   if defined(STM32L053xx)
#       define VL53L0A1_GPIO1_C_INTx        EXTI0_1_IRQn
#       define VL53L0A1_EXTI0_1_USE_PIN     VL53L0A1_GPIO1_C_GPIO_PIN
#   endif // STM32L053xx
#endif

#if VL53L0A1_GPIO1_SHARED == 0
/* not shared interrupt configuration */
#if VL53L0A1_GPIO1_L_OPTION == 0
#   define VL53L0A1_GPIO1_L_GPIO_PORT   GPIOC
#   define VL53L0A1_GPIO1_L_CLK_ENABLE  __GPIOC_CLK_ENABLE
#   define VL53L0A1_GPIO1_L_GPIO_PIN    GPIO_PIN_7
#   if defined(STM32F401xE) || defined(STM32L476xx)
#       define VL53L0A1_GPIO1_L_INTx       EXTI9_5_IRQn
#       define VL53L0A1_EXTI9_5_USE_PIN    VL53L0A1_GPIO1_L_GPIO_PIN
#   endif // STM32F401xE
#   if defined(STM32L053xx)
#       define VL53L0A1_GPIO1_L_INTx        EXTI4_15_IRQn
#       define VL53L0A1_EXTI4_15_USE_PIN_2   VL53L0A1_GPIO1_L_GPIO_PIN
#       ifndef VL53L0A1_EXTI4_15_USE_PIN
#           define VL53L0A1_EXTI4_15_USE_PIN    VL53L0A1_GPIO1_L_GPIO_PIN
#       else
#           warning "shared use of interrupt 7 in group  4-15 for L sensor "
#       endif
#   endif // STM32L053xx
#else
#   define VL53L0A1_GPIO1_L_GPIO_PORT   GPIOA
#   define VL53L0A1_GPIO1_L_CLK_ENABLE  __GPIOA_CLK_ENABLE
#   define VL53L0A1_GPIO1_L_GPIO_PIN    GPIO_PIN_9
#   if defined(STM32F401xE) || defined(STM32L476xx)
#       define VL53L0A1_GPIO1_L_INTx       EXTI9_5_IRQn
#       define VL53L0A1_EXTI9_5_USE_PIN    VL53L0A1_GPIO1_L_GPIO_PIN
#   endif // STM32F401xE
...
#       endif
#   endif // STM32L053xx
#endif //else VL53L0A1_GPIO1_L_OPTION

#if VL53L0A1_GPIO1_R_OPTION == 0
#   define VL53L0A1_GPIO1_R_GPIO_PORT   GPIOA
#   define VL53L0A1_GPIO1_R_CLK_ENABLE  __GPIOA_CLK_ENABLE
#   define VL53L0A1_GPIO1_R_GPIO_PIN    GPIO_PIN_10
#   if defined(STM32F401xE) || defined(STM32L476xx)
#       define VL53L0A1_GPIO1_R_INTx       EXTI15_10_IRQn
#       define VL53L0A1_EXTI15_10_USE_PIN  VL53L0A1_GPIO1_R_GPIO_PIN
#   endif // STM32F401xE
#   if defined(STM32L053xx)
#       define VL53L0A1_GPIO1_R_INTx        EXTI4_15_IRQn
#       define VL53L0A1_EXTI4_15_USE_PIN_3  VL53L0A1_GPIO1_R_GPIO_PIN
#       ifndef VL53L0A1_EXTI4_15_USE_PIN
#           define VL53L0A1_EXTI4_15_USE_PIN    VL53L0A1_GPIO1_R_GPIO_PIN
#       else
#           warning "shared use of interrupt 10 in group 4-15 for R sensor"
#       endif
#   endif // STM32L053xx
#else
#   define VL53L0A1_GPIO1_R_GPIO_PORT   GPIOB
#   define VL53L0A1_GPIO1_R_CLK_ENABLE  __GPIOB_CLK_ENABLE
#   define VL53L0A1_GPIO1_R_GPIO_PIN    GPIO_PIN_5
#   if defined(STM32F401xE) || defined(STM32L476xx)
#       define VL53L0A1_GPIO1_R_INTx       EXTI9_5_IRQn //  conflict with VL53L0A1_GPIO1_L any option
#       define VL53L0A1_EXTI9_5_USE_PIN    VL53L0A1_GPIO1_R_GPIO_PIN
#   endif // STM32F401xE
#   if defined(STM32L053xx)
#       define VL53L0A1_GPIO1_R_INTx        EXTI4_15_IRQn
#       define VL53L0A1_EXTI4_15_USE_PIN_3  VL53L0A1_GPIO1_R_GPIO_PIN
...
#       endif // STM32L053xx
#   endif // STM32L053xx
#endif //else VL53L0A1_GPIO1_R_OPTION

#endif //else VL53L0A1_GPIO1_SHARED

/** @} */ /* defgroup L53L0A1_GPIO1_MAP */

/**
 * @defgroup XNUCLEO53L0A1_Debugging VL053L0A1  debugging
 * @{
 */

#ifndef  XNUCLEO53L0A1_TRACE
/**
 ...
 */
#   define XNUCLEO53L0A1_TRACE    0
#endif // XNUCLEO53L0A1_TRACE


/**
 * @def XNUCLEO53L0A1_ErrLog(...)
 ...
 */
#if XNUCLEO53L0A1_TRACE
#   define XNUCLEO53L0A1_ErrLog( msg, ...) trace_printf("[Err] %s l %d \t" msg "\n", __func__, __LINE__, ##__VA_ARGS__)
#else
#   define XNUCLEO53L0A1_ErrLog(...) (void)0
#endif



/** @} */ /* group XNUCLEO53L0A1_Debugging */


/**
 * @defgroup XNUCLEO53L0A1_Interface X-NUCLEO-53L0A1 BSP API
 * @{ */
...
/**
 * I2C1 handle
 * @note setup and configured by @ref XNUCLEO53L0A1_Init
 */
...
/**
 * Initialize VL053L0A1 STM32 expansion board
 *
...
/** @} */ /* defgroup XNUCLEO53L0A1_Interface */

/**
 * @ingroup XNUCLEO53L0A1_Interface
 ...
 *
 * End user is expected to override VL53L0A1_EXTI_Callback to catch interrupts.
 ...
 * @param DevNo       Device number "name"  of the sensor see @ref XNUCLEO53L0A1_dev_e
 *
 ...
 *         >0 interrupt configured but with potential sharing on EXTI groups see @ref VL53L0A1_GPIO1_MAP
 */
 ...
 *
 * This function configures GPIO i/o and NVIC.  See  @ref VL53L0A1_GPIO1_MAP for details
 * To enable interrupt handling use @ref XNUCLEO53L0A1_SetIntrStateId()
 *
 * The input pullup/pulldown is configured by static configuration @a #VL53L0A1_INTR_PIN_PUPD
 *
 ...
 *
 * @param DevNo       device number see @ref XNUCLEO53L0A1_dev_e
